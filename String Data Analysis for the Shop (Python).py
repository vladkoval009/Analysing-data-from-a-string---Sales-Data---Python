#String data analyse for the shop
...
for eachTransaction in daily_transactions:
  daily_transactions_split.append(eachTransaction.split(" + "))
...
for transaction in daily_transactions_split:
  ...
  for data_point in transaction:
    one_transaction.append(data_point.replace("\n","").strip(" "))
...
for i_transaction in transactions_clean:
  #customers.append(i_transaction[0])
  sales.append(i_transaction[1])
  thread_sold.append(i_transaction[2])
...
for colour in colours:
  print("Thread Sold {0} threads of {1} thread today."
